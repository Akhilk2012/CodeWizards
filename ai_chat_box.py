                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if set_button.draw() == True:
                        ...
                        if points_typed :
                            ...
                            return
                        if time_typed :
                           timer_thread(text_input_5.text)
           
                       
                           
            draw_text("Points for the task :", 50, 200 , white,font_sub)
            draw_text("Time due for the task :", 50, 100 , white,font_sub)
            draw_text( "Write in h(hours),m(minutes),s(seconds)", 50, 60 , white,font_sub)
            set_button.draw()
            text_input_5.draw()
            text_input_3.draw()
            pygame.display.update()
